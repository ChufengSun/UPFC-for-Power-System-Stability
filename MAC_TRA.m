 ...
 if flag == 0; % initialization         
  if i ~= 0
    ...
    if length(tra)~=0 
      ...
      E_Isat = max(eqprime(i,1),E_Isat); % select higher
                                         % voltage
    ...
    E_Isat = max(eqprime(mac_tra_idx,1),E_Isat); % select higher
                                         % voltage
 ...
 if flag == 2 | flag == 3 % generator dynamics calculation
  if i ~= 0
    ...
    if length(tra)~=0
      ...
      E_Isat = max(eqprime(i,k),E_Isat); % select higher
                                         % voltage
    ...
    E_Isat = max(eqprime(mac_tra_idx,k),E_Isat); % select higher
                                         % voltage
