function [Y11,Y12,Y21,Y22,rec_V1,rec_V2,bus_order,Y_upfc,V_upfc] =...
...
global fromBus1 toBus2 xE_1 z11_ z12_ zt_1
...
theta(1:nbus,1)=bus_sol(:,3)*pi/180;
bus_volt(1:nbus,1)=bus_sol(:,2).*exp(jay*theta(1:nbus,1));


Y_d(fromBus1,fromBus1)=Y_d(fromBus1,fromBus1)+Y_d(fromBus1,toBus2);
Y_d(fromBus1,toBus2)=0;
Y_d(toBus2,toBus2)=Y_d(toBus2,toBus2)+Y_d(toBus2,fromBus1);
Y_d(toBus2,fromBus1)=0;

Y_d(fromBus1,fromBus1)=Y_d(fromBus1,fromBus1)-(z12_+jay*xE_1)/zt_1;
Y_d(fromBus1,toBus2)=jay*xE_1/zt_1;
Y_d(toBus2,toBus2)=Y_d(toBus2,toBus2)-(z11_+jay*xE_1)/zt_1;
Y_d(toBus2,fromBus1)=jay*xE_1/zt_1;

C=zeros(nbus,2);
C(fromBus1,1)=z12_/zt_1;
C(fromBus1,2)=-jay*xE_1/zt_1;
C(toBus2,1)=z11_/zt_1;
C(toBus2,2)=(z11_+jay*xE_1)/zt_1;
